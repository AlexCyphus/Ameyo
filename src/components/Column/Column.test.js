...
it("renders with item", () => {
  act(() => {
    ...
    render(<DragDropContext><Column items={items} monthlyHabitsCount={{}} column={column} inputs="" colors={{}} claimColor={() => {}}/></DragDropContext>, container);
  })
  expect(container.textContent).toBe("Habits0this is a test card");
});
